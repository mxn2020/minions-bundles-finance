...
export default defineConfig({
    ...
    integrations: [
        starlight({
            ...
            title: 'Minions Bundle: Finance',
            description: 'Financial tracking bundle — budgets, expenses, invoices',
            defaultLocale: 'root',
            locales: {
                root: { label: 'English', lang: 'en' },
            },
            social: [
                { icon: 'github', label: 'GitHub', href: 'https://github.com/mxn2020/minions-bundles-finance' },
